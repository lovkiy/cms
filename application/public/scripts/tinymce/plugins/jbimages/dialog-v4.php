...
<body>
    ...
    <form class="form-inline" id="upl" name="upl" action="http://<?=$_SERVER['SERVER_NAME']?>/application/public/scripts/tinymce/plugins/jbimages/ci/index.php/upload/english" method="post" enctype="multipart/form-data" target="upload_target" onsubmit="jbImagesDialog.inProgress();">
