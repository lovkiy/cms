...
$config['img_path'] = $_SEVER['SERVER_NAME'].'/uploads/images'; // Relative to domain name
$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] .'/application/public/uploads/images'; // Physical path. [Usually works fine like this]
